...
Learn about GPUtopia and how to trade GPU compute or contribute. {{ className: 'lead' }}

<div className="mb-16 mt-6 flex gap-3">
  <Button href="/quickstart" arrow="right" children="Quickstart" />
  <Button href="/sdks" variant="outline" children="Read the FAQ" />
</div>

## heeres a nm utgjkh jhg
