...
For now the only way to use GPU compute is to access it through our AI chat interface. See [Buying Compute](/docs/buying) for details.

We'll soon support other ways of buying compute like renting entire GPUs.
