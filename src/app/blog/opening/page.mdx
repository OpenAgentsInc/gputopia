...
"OpenAI" has now become exactly what it was founded to oppose: just another secretive large company building whatever they want while lobbying governments to prevent others from doing the same.
...
We will organize work on these bounties in the <ExternalLink href="https://github.com/ArcadeLabsInc/gputopia">GPUtopia repo on GitHub</ExternalLink> and our new <ExternalLink href="https://discord.gg/snxJSJDk">community Discord server</ExternalLink> you are welcome to join.

## The first goal

We begin with a relentless focus on one goal:

**Within the next 30 days, we aim to have 150 GPU sellers achieve a minimum monthly profit of $500 each from buyers on the GPUtopia marketplace.**

Anything you can do to help us toward that goal, please <ExternalLink href="https://discord.gg/snxJSJDk">join our Discord</ExternalLink> and let us know.
...
Whether it does &mdash; and how soon &mdash; is up to you.

**Let’s get started.**

<div className="mt-8 w-full">
  <a href="https://discord.gg/snxJSJDk" className="block w-full">
...
<div className="mt-12 text-xs opacity-75 italic">
  Previous post: [Toward an Open GPU Mesh](/blog/intro)
</div>
